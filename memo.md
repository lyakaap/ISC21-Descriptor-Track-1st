...
- v107: v98 -> query-reference pairを学習 with neg ref, x32, lr=0.5
- v108: v98 -> query-reference pairを学習 with neg ref, x32, lr=0.7
- v109: v98 -> query-reference pairを学習 with neg ref, x32, lr=1.0
- v110: v98 -> query-reference pairを学習 with neg ref, x32, lr=1.0, res=640
