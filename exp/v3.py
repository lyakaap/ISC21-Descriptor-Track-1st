...
parser.add_argument('--sample-size', default=1000000, type=int)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = ISCNet(backbone, p=args.gem_p, eval_p=args.gem_eval_p, s=args.s, margin=args.margin, num_classes=args.sample_size)
    ...
    progress = tqdm(train_loader, desc=f'init weight', leave=False, total=len(train_loader))
    ...
    model.module.loss_module.weight.data[labels.cuda()] = nn.Parameter(feats.cuda())
