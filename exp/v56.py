...
def main_worker(gpu, ngpus_per_node, args):
    ...
    aug_list = [
        ...
        ShufflePixels(factor=0.1, p=0.1),
        OneOf([EncodingQuality(quality=q) for q in [10, 20, 30, 50]], p=0.2),
        ...
        RandomEmojiOverlay(p=0.1),
        OneOf([RandomEdgeEnhance(mode=ImageFilter.EDGE_ENHANCE), RandomEdgeEnhance(mode=ImageFilter.EDGE_ENHANCE_MORE)], p=0.1),
    ]
    aug_hard = [
