...
from augly.image.functional import overlay_emoji, overlay_text, pad
...
class RandomPad(BaseTransform):
    ...
    def apply_transform(
        ...
        w_mask, h_mask = random.sample([0, 1], k=2)
        return pad(
            image,
            w_factor=random.uniform(0.1, 0.25) * w_mask,
            h_factor=random.uniform(0.1, 0.25) * h_mask,
