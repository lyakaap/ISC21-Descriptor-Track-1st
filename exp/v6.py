...
parser.add_argument('--margin', '-m', default=0.05, type=float)
parser.add_argument('--type-of-triplets', default='all', type=str)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    miner = miners.TripletMarginMiner(margin=args.margin, type_of_triplets=args.type_of_triplets)
